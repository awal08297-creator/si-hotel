...
<div class="col-lg-3 col-6">
    <div class="small-box bg-info">
        <div class="inner">
            ...
            $query_kamar = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tbl_kamar WHERE status='Tersedia'");
        ...
        <a href="?menu=kamar" class="small-box-footer">Lihat Detail <i class="bi bi-arrow-right"></i></a>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                    <div class="inner">
                        <?php
                        $today = date('Y-m-d');
                        $query_checkin = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tbl_reservasi WHERE tgl_checkin='$today' AND status='Confirmed'");
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <?php
                        $query_checkout = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tbl_reservasi WHERE tgl_checkout='$today' AND status='Checked In'");
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-danger">
                    <div class="inner">
                        ...
                        SELECT COALESCE(SUM(k.harga * r.jumlah_malam), 0) AS total
                        FROM tbl_pembayaran p
                        JOIN tbl_reservasi r ON p.id_reservasi = r.id_reservasi
                        JOIN tbl_kamar k ON r.id_kamar = k.id_kamar
                        WHERE p.status = 'lunas'
                          AND p.tanggal_bayar IS NOT NULL
                    ");
